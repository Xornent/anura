...
namespace Anura.JavaScript.Formatter {
    ...
    internal class Tokenizer : ParsingHelper {
        ...
        private static readonly Dictionary<char, TokenType> NamedOperators = new Dictionary<char, TokenType> () {
            ['{'] = TokenType.OpenBrace, ['}'] = TokenType.CloseBrace, ['('] = TokenType.OpenParen, [')'] = TokenType.CloseParen, ['['] = TokenType.OpenBracket, [']'] = TokenType.CloseBracket, [':'] = TokenType.Colon, ['.'] = TokenType.Dot, [';'] = TokenType.SemiColon, [','] = TokenType.Comma, ['?'] = TokenType.QuestionMark,
        };
        ...
        public Tokenizer (string script) : base (script) {
