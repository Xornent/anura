...
namespace Anura.JavaScript {
    public class JavaScriptParser {
        ...
        public Anura.JavaScript.Ast.Program CreateProgram (ICollection<Statement> body, bool strict) {
            return new Anura.JavaScript.Ast.Program {
        ...
        private Anura.JavaScript.Ast.Program ParseProgram () {
            EnterVariableScope ();
            EnterFunctionScope ();
        ...
        public Anura.JavaScript.Ast.Program Parse (string code) {
            return Parse (code, null);
        }

        public Anura.JavaScript.Ast.Program Parse (string code, ParserOptions options) {
            Anura.JavaScript.Ast.Program program;
