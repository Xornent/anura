...
namespace Anura.Styles {
    internal sealed class SelectorConstructor {
        ...
        private static readonly Dictionary<string, Func<SelectorConstructor, FunctionState>> pseudoClassFunctions =
            new Dictionary<string, Func<SelectorConstructor, FunctionState>> (StringComparer.OrdinalIgnoreCase) { { PseudoClassNames.NthChild, ctx => new ChildFunctionState<FirstChildSelector> (ctx) }, { PseudoClassNames.NthLastChild, ctx => new ChildFunctionState<LastChildSelector> (ctx) }, { PseudoClassNames.NthOfType, ctx => new ChildFunctionState<FirstTypeSelector> (ctx, false) }, { PseudoClassNames.NthLastOfType, ctx => new ChildFunctionState<LastTypeSelector> (ctx, false) }, { PseudoClassNames.NthColumn, ctx => new ChildFunctionState<FirstColumnSelector> (ctx, false) }, { PseudoClassNames.NthLastColumn, ctx => new ChildFunctionState<LastColumnSelector> (ctx, false) }, { PseudoClassNames.Not, ctx => new NotFunctionState (ctx) }, { PseudoClassNames.Dir, ctx => new DirFunctionState () }, { PseudoClassNames.Lang, ctx => new LangFunctionState () }, { PseudoClassNames.Contains, ctx => new ContainsFunctionState () }, { PseudoClassNames.Has, ctx => new HasFunctionState (ctx) }, { PseudoClassNames.Matches, ctx => new MatchesFunctionState (ctx) }, { PseudoClassNames.HostContext, ctx => new HostContextFunctionState (ctx) }
            };
