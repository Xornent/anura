    ...
    internal sealed class JintObjectExpression : JintExpression
    {
        ...
        protected override void Initialize()
        {
            ...
            for (var i = 0; i < _properties.Length; i++)
            {
                ...
                {
                    Anura.JavaScript.Runtime.ExceptionHelper.ThrowArgumentOutOfRangeException("property", "cannot handle property " + property);
                }
        ...
        private object BuildObjectNormal()
        {
            ...
            for (var i = 0; i < _properties.Length; i++)
            {
                ...
                {
                    var function = property.Value as IFunction ?? Anura.JavaScript.Runtime.ExceptionHelper.ThrowSyntaxError<IFunction>(_engine);
                ...
                {
                    return Anura.JavaScript.Runtime.ExceptionHelper.ThrowArgumentOutOfRangeException<object>();
                }
