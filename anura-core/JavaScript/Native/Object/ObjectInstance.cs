...
namespace Anura.JavaScript.Native.Object
{
    public class ObjectInstance : JsValue, IEquatable<ObjectInstance>
    {
        ...
        internal static ICallable GetMethod(Engine engine, JsValue v, JsValue p) {
            ...
            return jsValue as ICallable ?? Anura.JavaScript.Runtime.ExceptionHelper.ThrowTypeError<ICallable>(engine, "Value returned for property '" + p + "' of object is not a function");
        }
