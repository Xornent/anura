    ...
    public sealed class PseudoClassSelectorFactory
    {
        ...
        private static readonly Dictionary<string, ISelector> _selectors =
            new Dictionary<string, ISelector>(StringComparer.OrdinalIgnoreCase) {
                ...
                }, { PseudoClassNames.Active, SimpleSelector.PseudoClass (PseudoClassNames.Active) }, { PseudoClassNames.Hover, SimpleSelector.PseudoClass (PseudoClassNames.Hover) }, { PseudoClassNames.Focus, SimpleSelector.PseudoClass (PseudoClassNames.Focus) }, { PseudoClassNames.Target, SimpleSelector.PseudoClass (PseudoClassNames.Target) }, {
